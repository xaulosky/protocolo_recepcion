...
export const consentimientosData = [
    ...
    {
        id: 'hydrafacial',
        title: 'CONSENTIMIENTO INFORMADO HYDRAFACIAL',
        treatment: 'HydraFacial',
        introduction: 'HydraFacial es un tratamiento de limpieza facial profunda mediante hidrodermoabrasión, que combina succión controlada con la aplicación de soluciones exfoliantes, hidratantes y antioxidantes. Su finalidad es mejorar la textura, luminosidad e hidratación de la piel, eliminando puntos negros, comedones e impurezas, y estimulando la regeneración celular. El procedimiento utiliza puntas desechables y materiales estériles, siendo no invasivo y cosmetológicamente seguro.',
        beneficios: [
            'Piel más limpia, suave, luminosa e hidratada.',
            'Reducción visible de puntos negros y poros dilatados.',
            'Apariencia más uniforme y revitalizada del rostro.',
            'Estimulación de la regeneración celular.',
            'Sin tiempo de recuperación: puede retomar actividades inmediatamente.',
        ],
        efectosSecundarios: [
            'Enrojecimiento o leve inflamación transitoria de la piel.',
            'Sensación de calor, tirantez o resequedad posterior al tratamiento.',
            'Leve descamación o sensibilidad transitoria.',
            'En casos poco frecuentes: reacción alérgica a alguno de los productos utilizados (ácidos suaves, sueros o antioxidantes).',
        ],
        contraindicaciones: [
            'Enfermedades de la piel activas, heridas abiertas o infecciones cutáneas en la zona.',
            'Consumo de isotretinoína o fármacos fotosensibilizantes.',
            'Alergias conocidas a productos cosméticos o ácidos utilizados en el tratamiento.',
            'Condiciones médicas no informadas que puedan representar riesgo para el procedimiento.',
        ],
        cuidados: [
            'Evitar exposición directa al sol por 24 a 48 horas posteriores al tratamiento.',
            'Usar bloqueador solar SPF 50+ diariamente.',
            'No exfoliar, depilar ni aplicar productos irritantes durante las 48 horas siguientes.',
            'Mantener la piel hidratada y limpia según indicaciones del profesional.',
        ]
    },
    {
        id: 'xwave',
        title: 'CONSENTIMIENTO INFORMADO PARA TRATAMIENTO CON ONDAS DE CHOQUE – X-WAVE',
        treatment: 'X-Wave (Ondas de Choque)',
        introduction: 'El tratamiento con X-Wave utiliza tecnología de ondas acústicas de alta energía que actúan a nivel subcutáneo, estimulando la microcirculación, activando el drenaje linfático, mejorando la elasticidad de la piel y favoreciendo la reorganización de fibras de colágeno. Su finalidad es mejorar la apariencia de la celulitis, disminuir fibrosis y adherencias, favorecer el modelado corporal y mejorar la textura y tonicidad cutánea. Los resultados varían según metabolismo, grado de celulitis, estilo de vida, hidratación, alimentación y constancia en las sesiones.',
        beneficios: [
            'Mejora visible de la apariencia de la celulitis.',
            'Disminución de fibrosis y adherencias subcutáneas.',
            'Mejora de la textura y firmeza de la piel.',
            'Disminución de nódulos fibrosos.',
            'Favorece el modelado corporal sin procedimientos invasivos.',
        ],
        efectosSecundarios: [
            'Enrojecimiento local transitorio.',
            'Sensibilidad o leve dolor en la zona tratada.',
            'Aparición de pequeños hematomas en piel sensible.',
            'Inflamación leve y transitoria.',
            'Sensación de golpeteo rítmico y presión durante el procedimiento.',
        ],
        contraindicaciones: [
            'Trastornos de coagulación o uso de anticoagulantes.',
            'Embarazo o período de lactancia.',
            'Infecciones activas, heridas o inflamación en la zona a tratar.',
            'Várices severas o trombosis.',
            'Enfermedades autoinmunes o patologías crónicas relevantes.',
            'Implantes metálicos en la zona tratada.',
        ],
        cuidados: [
            'Mantener adecuada hidratación antes y después del tratamiento.',
            'Evitar antiinflamatorios sin indicación posterior a la sesión (según recomendación profesional).',
            'Asistir puntualmente a las sesiones programadas.',
            'Complementar con hábitos saludables (alimentación, ejercicio) para potenciar resultados.',
        ]
    },
    {
        id: 'limpieza-facial-profunda',
        title: 'CONSENTIMIENTO INFORMADO PARA LIMPIEZA FACIAL PROFUNDA',
        treatment: 'Limpieza Facial Profunda',
        introduction: 'La limpieza facial profunda es un procedimiento cosmetológico cuyo objetivo principal es eliminar células muertas de la superficie de la piel, favorecer la oxigenación y permitir una mejor absorción de los productos cosméticos aplicados posteriormente. El procedimiento utiliza materiales estériles y puntas desechables incluidas en el valor del tratamiento, garantizando condiciones cosmetológicamente seguras y no invasivas.',
        beneficios: [
            'Retardo en la aparición de líneas de expresión.',
            'Mejora de la luminosidad y textura de la piel.',
            'Eliminación de puntos negros y comedones.',
            'Piel más tersa, suave y revitalizada.',
            'Mejora en la absorción de productos cosméticos posteriores.',
        ],
        efectosSecundarios: [
            'Enrojecimiento o leve inflamación transitoria, especialmente en zonas donde se realizaron extracciones.',
            'Sensación de tirantez o resequedad posterior al procedimiento.',
            'Pequeñas descamaciones o sensibilidad transitoria.',
            'En casos poco frecuentes: reacción alérgica a alguno de los productos utilizados durante la limpieza.',
        ],
        contraindicaciones: [
            'Enfermedades dermatológicas activas, lesiones sospechosas, heridas abiertas o infecciones cutáneas.',
            'Consumo de isotretinoína o fármacos que alteren la coagulación sanguínea.',
            'Hemofilia o trastornos de coagulación.',
            'Condiciones médicas no informadas que puedan representar riesgo para la realización del procedimiento.',
        ],
        cuidados: [
            'No exponerse directamente al sol por 24 a 48 horas posteriores al tratamiento.',
            'Usar bloqueador solar de manera continua.',
            'Evitar tocar o exfoliar el rostro durante las primeras 24 a 48 horas.',
            'Mantener la piel hidratada según indicaciones del profesional.',
        ]
    },
    {
        id: 'post-quirurgico',
        title: 'CONSENTIMIENTO INFORMADO PARA TRATAMIENTOS POST QUIRÚRGICOS',
        treatment: 'Tratamiento Post Quirúrgico',
        marcoLegal: 'Este consentimiento se otorga conforme a la Ley N° 20.584, que regula los derechos y deberes de las personas en relación con acciones vinculadas a su atención en salud, y al Decreto N° 31 del Ministerio de Salud. El paciente tiene derecho a aceptar o rechazar libremente este tratamiento y puede revocar su decisión en cualquier momento antes de su ejecución.',
        introduction: 'El tratamiento post quirúrgico tiene como finalidad favorecer la recuperación tisular, disminuir la inflamación, prevenir fibrosis, mejorar el drenaje linfático y optimizar los resultados estéticos posteriores a una cirugía. El plan de tratamiento es personalizado y sujeto a evaluación clínica en cada sesión. Los procedimientos que pueden formar parte del protocolo incluyen: drenaje linfático manual, ultrasonido terapéutico, fototerapia LED, ondas de choque (según presencia de fibrosis o indicación clínica), vendaje neuromuscular (kinesiotape) y técnicas manuales complementarias. No todos los procedimientos se aplican en todos los casos; su indicación dependerá de la evolución clínica, el tipo de cirugía y el estado del tejido.',
        beneficios: [
            'Disminución del edema e inflamación post operatoria.',
            'Prevención y manejo de fibrosis.',
            'Mejora del dolor post operatorio.',
            'Aceleración del proceso de recuperación.',
            'Optimización del resultado estético final.',
            'Mejora de la circulación y del drenaje linfático.',
        ],
        efectosSecundarios: [
            'Sensibilidad o molestia leve durante o después del tratamiento.',
            'Enrojecimiento cutáneo transitorio.',
            'Aumento temporal del edema.',
            'Pequeños hematomas.',
            'Sensación de cansancio posterior al drenaje linfático.',
            'Reacción cutánea leve al uso de vendaje neuromuscular.',
            'En casos poco frecuentes: dolor persistente, reacción inflamatoria exagerada o reacción alérgica al adhesivo.',
        ],
        contraindicaciones: [
            'Infección activa en la zona quirúrgica.',
            'Dehiscencia de herida o puntos abiertos.',
            'Fiebre o proceso infeccioso sistémico.',
            'Trombosis venosa profunda.',
            'Insuficiencia cardíaca descompensada.',
            'Enfermedades cutáneas activas en la zona.',
            'Hematomas expansivos no evaluados por médico.',
            'Contraindicación médica expresa.',
        ],
        cuidados: [
            'Asistir a todas las sesiones indicadas por el profesional tratante.',
            'Usar faja compresiva según indicación médica.',
            'Mantener adecuada hidratación.',
            'Evitar automasajes no indicados por el profesional.',
            'No aplicar calor local sin autorización médica.',
            'Seguir indicaciones médicas y kinésicas de manera estricta.',
            'Informar de inmediato ante signos de alarma: dolor intenso, aumento progresivo del edema, enrojecimiento severo, secreción o fiebre.',
            'Recordar que el tratamiento post quirúrgico es complementario y no reemplaza los controles médicos regulares.',
        ],
        registroFotografico: true,
    },
    {
    ...
    {
        id: 'morpheus-8',
        title: 'CONSENTIMIENTO INFORMADO MORPHEUS 8',
        treatment: 'Morpheus 8',
        introduction: 'Morpheus 8 es un dispositivo médico estético que combina radiofrecuencia fraccionada con microagujas para actuar en las capas profundas de la piel. Su objetivo es estimular la producción de colágeno y elastina, mejorar la calidad de la piel, tensar tejidos y atenuar signos de envejecimiento y flacidez. Puede utilizarse en rostro, cuello y cuerpo para rejuvenecimiento y remodelación cutánea.',
        beneficios: [
            'Estimulación de colágeno y elastina para mejorar la firmeza y elasticidad de la piel.',
            'Reducción de arrugas, líneas finas y cicatrices de acné.',
            'Disminución de flacidez cutánea en rostro y cuerpo.',
            'Mejora en la textura y tono de la piel.',
            'Remodelación del tejido subdérmico con efecto tensor.',
            'Procedimiento mínimamente invasivo y ambulatorio.',
            'Resultados progresivos que continúan mejorando durante los meses posteriores.',
        ],
        efectosSecundarios: [
            'Eritema (enrojecimiento) y edema en la zona tratada (1–3 días).',
            'Pequeños hematomas o sangrado puntual por las microagujas.',
            'Sensación de calor o ardor local.',
            'Descamación o sequedad transitoria de la piel.',
            'Molestia leve durante o posterior al tratamiento.',
            'En casos poco frecuentes: infección local, cambios en la pigmentación (hiper/hipopigmentación), cicatrices, resultados menores a lo esperado.',
        ],
        contraindicaciones: [
            'Embarazo o lactancia.',
            'Marcapasos, desfibriladores u otros implantes electrónicos.',
            'Implantes metálicos en la zona a tratar.',
            'Enfermedades dermatológicas activas en la zona (eczema, rosácea severa, psoriasis, herpes activo, infecciones cutáneas).',
            'Cicatrización anómala o tendencia a queloides.',
            'Trastornos hemorrágicos, uso de anticoagulantes o enfermedades de coagulación.',
            'Enfermedades autoinmunes o colagenopatías activas.',
            'Uso reciente de isotretinoína (últimos 6-12 meses).',
            'Cáncer activo o tratamiento oncológico reciente.',
        ],
        cuidados: [
            'Antes: acudir con la zona limpia, sin maquillaje ni cremas.',
            'Antes: evitar exposición solar intensa y procedimientos ablativos previos (mínimo 3 meses).',
            'Antes: informar al profesional sobre medicamentos, antecedentes médicos o estéticos recientes.',
            'Después: puede retomar actividades habituales salvo indicación médica.',
            'Después: usar fotoprotección diaria SPF 50+ y evitar sol directo por 2 semanas.',
            'Después: mantener la piel hidratada con productos suaves.',
            'Después: evitar piscinas, saunas, baños muy calientes y ejercicio intenso por 48 horas.',
            'Después: no manipular costras ni la zona con descamación.',
            'Después: seguir las indicaciones específicas entregadas por el profesional.',
        ],
    },
];

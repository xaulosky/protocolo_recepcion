...
export const tratamientosProfesionalesData = [
 ...
 */
export function getTratamientosByProfesional(profesionalId: string) {
 ...
 */
export function getProfesionalesByTratamiento(tratamientoId: string) {
 ...
 * @returns {boolean}
 */
export function profesionalRealizaTratamiento(profesionalId: string, tratamientoId: string) {
 ...
 */
export function getRelacionEstadisticas() {

...
function publicUser(u: { id: string; email: string; nombre: string; role: AccessPayload['role']; permisos: string[]; professionalId: string | null; telefono?: string | null; fechaNacimiento?: string | null; copilotoHabilitado?: boolean }) {
  return {
    id: u.id, email: u.email, nombre: u.nombre, role: u.role, permisos: u.permisos, professionalId: u.professionalId,
    telefono: u.telefono ?? null, fechaNacimiento: u.fechaNacimiento ?? null, copilotoHabilitado: u.copilotoHabilitado ?? false,
  };
}
